...
[
  ...
  (
    ...
    new Component({ tag: 'span',className: [style.span, style['first-side__word']],text: 'scopes' }),
    new Component({ tag: 'span',className: [style.span, style['first-side__word']],text: 'school' }),
    new Component({ tag: 'span',className: [style.span, style['first-side__word']],text: 'puzzle' }),
    new Component({ tag: 'span',className: [style.span, style['first-side__word']],text: 'game' }),
  ),
