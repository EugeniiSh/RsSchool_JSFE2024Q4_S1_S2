...
const scullTop = new Component({ tag: 'div', className: [style['scull-top']], text: '' });
const scullBottom = new Component({ tag: 'div', className: [style['scull-bottom']], text: '' });
const leftEye = new Component({ tag: 'div', className: [style['left-eye'], style.eye], text: '' });
const rightEye = new Component({ tag: 'div', className: [style['right-eye'], style.eye], text: '' });
