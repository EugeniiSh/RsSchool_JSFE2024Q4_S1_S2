...
import { InputText, IInputTextOptions, TInputTextFieldsCheckers } from '../../../modules/layout/login-form/input/input-text';
...
firstNamefieldCheckers.set('upperCase', (value: string) => value[0] ? value[0] === value[0].toUpperCase() : false);
...
export { firstName, firstNamefieldCheckers, firstNameInputListener, fieldFirstNameInputListener } ;