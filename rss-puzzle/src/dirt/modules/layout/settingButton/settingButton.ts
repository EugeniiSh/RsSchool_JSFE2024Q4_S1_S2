...
export class SettingButton extends Component
{
  ...
  )
  {
    ...
    this.settingContainer = new Component({tag: 'div', className: [this.style.settingContainer], text: ''});
    this.settingContainer.appendChildren([this.volumeSetting, this.closeButton]);
