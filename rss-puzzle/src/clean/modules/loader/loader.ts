...
export class Loader extends Component {
  ...
  constructor({ className, text, style }: ILoaderOption) {
    ...
    const part1 = new Component({
      tag: 'div',
      className: [this.style.part, this.style.part1],
      text: '',
    });
    const part2 = new Component({
      tag: 'div',
      className: [this.style.part, this.style.part2],
      text: '',
    });
    const part3 = new Component({
      tag: 'div',
      className: [this.style.part, this.style.part3],
      text: '',
    });
    const part4 = new Component({
      tag: 'div',
      className: [this.style.part, this.style.part4],
      text: '',
    });
    const part5 = new Component({
      tag: 'div',
      className: [this.style.part, this.style.part5],
      text: '',
    });
    const part6 = new Component({
      tag: 'div',
      className: [this.style.part, this.style.part6],
      text: '',
    });
    const part7 = new Component({
      tag: 'div',
      className: [this.style.part, this.style.part7],
      text: '',
    });
