...
const playFieldStyle: IPlayFieldStyleList = {
  ...
  wordBlockPieceLeftStatusCorrect:
    styleBlocks['word-block__piece_left__status_correct'],
  wordBlockPieceLeftStatusError:
    styleBlocks['word-block__piece_left__status_error'],
