...
const audioPlayerOption: IAudioPlayerOption = {
  ...
  songs: [
    'https://raw.githubusercontent.com/eugeniish/rss-puzzle-data/main/files/01_0001_example.mp3',
    'https://raw.githubusercontent.com/eugeniish/rss-puzzle-data/main/files/01_0002_example.mp3',
  ],
  autoPlay: true,
  loop: false,
};
